...
def A_plot(max_points):
    ...
    plt.legend()
    plt.savefig("A_score_winkeltripel", bbox_inches='tight')
    plt.show()
...
def I_plot(max_points):
    ...
    plt.legend()
    plt.savefig("I_score_winkeltripel", bbox_inches='tight')
    plt.show()
...
def D_plot(max_points):
    ...
    plt.legend()
    plt.savefig("D_score_winkeltripel", bbox_inches='tight')
    plt.show()
