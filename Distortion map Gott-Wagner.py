...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_Area_gottwagner", bbox_inches='tight')
plt.show()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_flexion_gottwagner", bbox_inches='tight')
plt.show()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_skewness_gottwagner", bbox_inches='tight')
plt.show()
...
plt.xlabel('X Pixel')
plt.ylabel('Y Pixel')
#plt.title('Contour Plot of the Area distortion of Mercator')
plt.tight_layout() 
plt.savefig("Contourplot_Isotropy_gottwagner", bbox_inches='tight')
plt.show()
