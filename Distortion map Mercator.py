...
mean = A_score()[1]                         #The mean needs to be determined for the local area distortion
...
plt.contourf(X, Y, A_dist, levels=alevels,colors=colors, extend='neither',alpha = 0.5)
plt.colorbar(label='Area distortion',shrink=0.3)
plt.xlabel('X Pixel')
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_area_mercator", bbox_inches='tight')
plt.show()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_flexion_mercator", bbox_inches='tight')
plt.show()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_skewness_mercator", bbox_inches='tight')
plt.show()
