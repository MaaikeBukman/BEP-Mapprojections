...
I_dist = np.full(( map_length , map_width),1e6)
A_dist = np.full((map_length,map_width),1e6)
F_dist = np.full((map_length,map_width),1e6)
S_dist = np.full((map_length,map_width),1e6)
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_Area_winkeltripel", bbox_inches='tight')
plt.show()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_Isotropy_winkeltripel", bbox_inches='tight')
plt.show()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_flexion_winkel", bbox_inches='tight')
plt.show()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_skewness_winkel", bbox_inches='tight')
plt.show()
