...
phi = np.arcsin(np.random.uniform(-0.999,0,num_points))
...
new_world1 = np.full((map_length, map_width, 3), 255, dtype=np.uint8) # this will be (y,x) and white
...
# Contour plot for flexion distortion half 1
plt.figure(dpi=400)
plt.axis('off')
plot_parallels()
plot_meridians()
...
plt.tight_layout() 
plt.savefig("Contourplot_flexion_azimtuahlhafl1", bbox_inches='tight')
plt.show()

# Contour plot for flexion distortion half 2
plt.figure(dpi=400)
plt.axis('off')
plot_parallels()
plot_meridians()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_flexion_azimtuahlhalf2", bbox_inches='tight')
plt.show()

# Contour plot for skewness distortion 2 half 1
plt.figure(dpi=400)
plt.axis('off')
plot_parallels()
plot_meridians()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_skewness_azimuthalhalf1", bbox_inches='tight')
plt.show()

# Contour plot for skewness distortion 2 half 2
plt.figure(dpi=400)
plt.axis('off')
plot_parallels()
plot_meridians()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_skewness_azimuthalhalf2", bbox_inches='tight')
plt.show()

# Contour plot for Area distortion 2 half 1
plt.figure(dpi=400)
plt.axis('off')
plot_parallels()
plot_meridians()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_Area_azimuthal2half1", bbox_inches='tight')
plt.show()

# Contour plot for Area distortion 2 half 2
plt.figure(dpi=400)
plt.axis('off')
plot_parallels()
plot_meridians()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_Area_azimuthal2half2", bbox_inches='tight')
plt.show()

# Contour plot for Isotropy distortion half 1
plt.figure(dpi=400)
plt.axis('off')
plot_parallels()
plot_meridians()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_Isotropy_azimuthalhalf1", bbox_inches='tight')
plt.show()

# Contour plot for Isotropy distortion half 2
plt.figure(dpi=400)
plt.axis('off')
plot_parallels()
plot_meridians()
...
plt.ylabel('Y Pixel')
plt.tight_layout() 
plt.savefig("Contourplot_Isotropy_azimuthalhalf2", bbox_inches='tight')
plt.show()
